...
const evaluaciones: Evaluacion[] = [
  ...
  {
    id: "mitosis-p",
    titulo: "División Celular — Mitosis y Meiosis",
    nivel: "Primaria",
    ...
    duracion: "35 min",
    preguntas: [
      { tipo: "multiple", enunciado: "¿Para qué sirve la mitosis?", opciones: ["Para que las células produzcan energía", "Para que el cuerpo crezca y repare tejidos", "Para fabricar hormonas", "Para digerir alimentos"], correcta: 1, puntos: 1 },
      { tipo: "multiple", enunciado: "¿Cuántas células hijas se obtienen de una mitosis?", opciones: ["1", "2", "4", "8"], correcta: 1, puntos: 1 },
      { tipo: "multiple", enunciado: "¿En qué fase se alinean los cromosomas en el centro de la célula?", opciones: ["Profase", "Anafase", "Metafase", "Telofase"], correcta: 2, puntos: 1 },
      { tipo: "vf", enunciado: "Las células hijas de la mitosis tienen la misma información genética que la célula madre.", correcta: true, puntos: 1 },
      { tipo: "vf", enunciado: "La meiosis produce 2 células hijas iguales a la célula original.", correcta: false, puntos: 1 },
      { tipo: "vf", enunciado: "Antes de dividirse, la célula debe copiar todo su ADN.", correcta: true, puntos: 1 },
      { tipo: "completar", enunciado: "La primera fase de la mitosis, donde se condensan los cromosomas, se llama ___.", respuesta: "profase", puntos: 1 },
      { tipo: "completar", enunciado: "La meiosis produce células con la ___ mitad del número de cromosomas que la célula original.", respuesta: "mitad", puntos: 1 },
      { tipo: "multiple", enunciado: "¿Cuántas células se obtienen al final de la meiosis?", opciones: ["2", "3", "4", "8"], correcta: 2, puntos: 1 },
      { tipo: "desarrollo", enunciado: "Explicá con tus palabras la diferencia entre mitosis y meiosis. ¿Para qué sirve cada una?", guia: "Mitosis: produce 2 células iguales para crecer y reparar. Meiosis: produce 4 gametos con la mitad de cromosomas para la reproducción sexual.", puntos: 3 },
    ],
  },
  {
    id: "micro-p",
    titulo: "Microbiología — El Mundo Invisible",
    nivel: "Primaria",
    modulo: "Microbiología",
    emoji: "🦠",
    color: "#4ade80",
    duracion: "35 min",
    preguntas: [
      { tipo: "multiple", enunciado: "¿Qué instrumento se usa para ver microorganismos?", opciones: ["Telescopio", "Microscopio", "Termómetro", "Estetoscopio"], correcta: 1, puntos: 1 },
      { tipo: "multiple", enunciado: "¿Cuál de estos ES un microorganismo?", opciones: ["Hormiga", "Bacteria", "Mosca", "Pulga"], correcta: 1, puntos: 1 },
      { tipo: "multiple", enunciado: "¿Qué son los antibióticos?", opciones: ["Medicamentos que matan virus", "Medicamentos que matan bacterias", "Vitaminas para crecer", "Vacunas contra hongos"], correcta: 1, puntos: 1 },
      { tipo: "vf", enunciado: "Todas las bacterias son perjudiciales para los seres humanos.", correcta: false, puntos: 1 },
      { tipo: "vf", enunciado: "Los virus necesitan entrar en una célula viva para poder reproducirse.", correcta: true, puntos: 1 },
      { tipo: "vf", enunciado: "Lavarse las manos ayuda a prevenir la transmisión de microorganismos.", correcta: true, puntos: 1 },
      { tipo: "completar", enunciado: "Las bacterias que viven en nuestro intestino y ayudan a la digestión forman la ___ intestinal.", respuesta: "microbiota (o flora bacteriana)", puntos: 1 },
      { tipo: "completar", enunciado: "Un ___ es una sustancia que entrena al sistema inmune para reconocer una enfermedad sin causarla.", respuesta: "vacuna", puntos: 1 },
      { tipo: "multiple", enunciado: "¿Cuál de estos microorganismos puede causar infecciones en heridas?", opciones: ["Virus del resfriado", "Bacteria Staphylococcus", "Hongo de la levadura (en el pan)", "Alga verde"], correcta: 1, puntos: 1 },
      { tipo: "desarrollo", enunciado: "Mencioná 3 medidas de higiene que prevengan enfermedades causadas por microorganismos y explicá por qué funcionan.", guia: "Lavado de manos (elimina bacterias de la piel), cocción de alimentos (mata patógenos), vacunas (generan defensa preventiva), uso de mascarilla (evita gotas respiratorias).", puntos: 3 },
    ],
  },
  {
    id: "muscular-p",
    ...
    duracion: "35 min",
    preguntas: [
      { tipo: "multiple", enunciado: "¿Cuántos músculos aproximadamente tiene el cuerpo humano?", opciones: ["Menos de 100", "Alrededor de 600", "Más de 2000", "Exactamente 206"], correcta: 1, puntos: 1 },
      { tipo: "multiple", enunciado: "¿Qué tipo de músculo mueve los huesos cuando queremos?", opciones: ["Músculo liso", "Músculo cardíaco", "Músculo esquelético", "Músculo involuntario"], correcta: 2, puntos: 1 },
      { tipo: "multiple", enunciado: "¿Qué músculo bombea sangre en el corazón?", opciones: ["Músculo liso", "Músculo esquelético", "Músculo cardíaco", "Músculo estriado voluntario"], correcta: 2, puntos: 1 },
      { tipo: "vf", enunciado: "Los músculos solo pueden empujar, nunca jalar.", correcta: false, puntos: 1 },
      { tipo: "vf", enunciado: "El músculo liso se encuentra en los órganos internos como el estómago y los intestinos.", correcta: true, puntos: 1 },
      { tipo: "vf", enunciado: "El ejercicio físico hace que los músculos se debiliten.", correcta: false, puntos: 1 },
      { tipo: "completar", enunciado: "Los músculos se unen a los huesos a través de los ___.", respuesta: "tendones", puntos: 1 },
      { tipo: "completar", enunciado: "Cuando el bíceps se ___, el codo se dobla; cuando se relaja, el tríceps lo extiende.", respuesta: "contrae", puntos: 1 },
      { tipo: "multiple", enunciado: "¿Cuál es la unidad funcional básica del músculo esquelético?", opciones: ["Neurona", "Fibra muscular (célula muscular)", "Tendón", "Cartílago"], correcta: 1, puntos: 1 },
      { tipo: "desarrollo", enunciado: "Explicá los 3 tipos de músculos del cuerpo humano. ¿En qué parte del cuerpo se encuentra cada uno?", guia: "Esquelético: voluntario, mueve huesos (brazos, piernas). Cardíaco: involuntario, en el corazón. Liso: involuntario, en órganos internos (estómago, intestinos, vasos sanguíneos).", puntos: 3 },
    ],
  },
  {
    id: "excretor-p",
    titulo: "El Sistema Excretor",
    nivel: "Primaria",
    modulo: "Sistema Excretor",
    emoji: "🫘",
    color: "#facc15",
    duracion: "35 min",
    preguntas: [
      { tipo: "multiple", enunciado: "¿Cuál es la función principal de los riñones?", opciones: ["Producir hormonas", "Filtrar la sangre y eliminar desechos", "Bombear sangre", "Digerir proteínas"], correcta: 1, puntos: 1 },
      { tipo: "multiple", enunciado: "¿Cómo se llama el líquido producido por los riñones?", opciones: ["Sangre", "Bilis", "Orina", "Linfa"], correcta: 2, puntos: 1 },
      { tipo: "multiple", enunciado: "¿Por dónde pasa la orina desde los riñones hasta la vejiga?", opciones: ["Urethra", "Uretra", "Uréteres", "Intestinos"], correcta: 2, puntos: 1 },
      { tipo: "vf", enunciado: "El sudor también ayuda a eliminar desechos del cuerpo.", correcta: true, puntos: 1 },
      { tipo: "vf", enunciado: "Los pulmones solo sirven para respirar y no participan en la excreción.", correcta: false, puntos: 1 },
      { tipo: "vf", enunciado: "Tomar agua suficiente ayuda a los riñones a funcionar mejor.", correcta: true, puntos: 1 },
      { tipo: "completar", enunciado: "Cada riñón contiene millones de pequeñas unidades de filtración llamadas ___.", respuesta: "nefronas", puntos: 1 },
      { tipo: "completar", enunciado: "La vejiga almacena la orina hasta que el cuerpo la elimina a través de la ___.", respuesta: "uretra", puntos: 1 },
      { tipo: "multiple", enunciado: "¿Qué órgano además de los riñones ayuda a eliminar desechos mediante el sudor?", opciones: ["Hígado", "Pulmones", "Piel", "Páncreas"], correcta: 2, puntos: 1 },
      { tipo: "desarrollo", enunciado: "Explicá el recorrido que hace la sangre sucia y cómo el sistema excretor la limpia.", guia: "La sangre con desechos (urea, sales, agua extra) llega al riñón por la arteria renal → las nefronas filtran y reabsorben nutrientes → se forma orina → pasa por uréteres → vejiga → uretra al exterior.", puntos: 3 },
    ],
  },
  {
    id: "endocrino-p",
    titulo: "El Sistema Endócrino — Mensajeros del Cuerpo",
    nivel: "Primaria",
    modulo: "Sistema Endócrino",
    emoji: "⚗️",
    color: "#fb923c",
    duracion: "35 min",
    preguntas: [
      { tipo: "multiple", enunciado: "¿Cómo se llaman los mensajeros químicos que viajan por la sangre?", opciones: ["Neuronas", "Hormonas", "Enzimas", "Anticuerpos"], correcta: 1, puntos: 1 },
      { tipo: "multiple", enunciado: "¿Qué glándula produce la insulina para controlar el azúcar en sangre?", opciones: ["Tiroides", "Páncreas", "Suprarrenal", "Hipófisis"], correcta: 1, puntos: 1 },
      { tipo: "multiple", enunciado: "¿Qué hormona produce la tiroides?", opciones: ["Insulina", "Adrenalina", "Tiroxina", "Estrógeno"], correcta: 2, puntos: 1 },
      { tipo: "vf", enunciado: "Las glándulas endócrinas vierten sus hormonas directamente en la sangre.", correcta: true, puntos: 1 },
      { tipo: "vf", enunciado: "La adrenalina es la hormona que nos pone en alerta ante situaciones de peligro.", correcta: true, puntos: 1 },
      { tipo: "vf", enunciado: "El sistema endócrino trabaja igual de rápido que el sistema nervioso.", correcta: false, puntos: 1 },
      { tipo: "completar", enunciado: "La ___ del cerebro es conocida como 'glándula maestra' porque controla a otras glándulas.", respuesta: "hipófisis (hipófisis o pituitaria)", puntos: 1 },
      { tipo: "completar", enunciado: "Una persona con diabetes tipo 1 no produce suficiente ___, por lo que necesita inyectársela.", respuesta: "insulina", puntos: 1 },
      { tipo: "multiple", enunciado: "¿Cuál de estas es una función de las hormonas sexuales durante la pubertad?", opciones: ["Regular el azúcar en sangre", "Desarrollar caracteres sexuales secundarios", "Controlar la presión arterial", "Producir glóbulos rojos"], correcta: 1, puntos: 1 },
      { tipo: "desarrollo", enunciado: "Explicá con un ejemplo cómo funciona una hormona: ¿de dónde viene, cómo viaja y qué hace en el cuerpo?", guia: "Ej. insulina: producida por el páncreas → pasa a la sangre → llega a células del hígado y músculo → les indica que absorban glucosa para bajar el azúcar en sangre.", puntos: 3 },
    ],
  },
  {
    id: "reproductor-p",
    ...
    duracion: "35 min",
    preguntas: [
      { tipo: "multiple", enunciado: "¿Cómo se llaman los órganos femeninos que producen los óvulos?", opciones: ["Trompas de Falopio", "Ovarios", "Útero", "Vagina"], correcta: 1, puntos: 1 },
      { tipo: "multiple", enunciado: "¿En qué órgano se desarrolla el bebé durante el embarazo?", opciones: ["Ovario", "Trompa de Falopio", "Útero", "Vagina"], correcta: 2, puntos: 1 },
      { tipo: "multiple", enunciado: "¿Cada cuánto tiempo aproximadamente ocurre la ovulación?", opciones: ["Cada semana", "Cada mes", "Cada 3 meses", "Cada año"], correcta: 1, puntos: 1 },
      { tipo: "vf", enunciado: "Los ovarios producen los óvulos y también hormonas como el estrógeno.", correcta: true, puntos: 1 },
      { tipo: "vf", enunciado: "Las trompas de Falopio conectan los ovarios con el útero.", correcta: true, puntos: 1 },
      { tipo: "vf", enunciado: "La fertilización (unión del óvulo con el espermatozoide) ocurre en el útero.", correcta: false, puntos: 1 },
      { tipo: "completar", enunciado: "El proceso por el que el óvulo sale del ovario se llama ___.", respuesta: "ovulación", puntos: 1 },
      { tipo: "completar", enunciado: "El bebé se alimenta a través de la ___, que lo une a la placenta.", respuesta: "placenta (o cordón umbilical)", puntos: 1 },
      { tipo: "multiple", enunciado: "¿Dónde suele ocurrir la fertilización del óvulo?", opciones: ["En el útero", "En el ovario", "En la trompa de Falopio", "En la vagina"], correcta: 2, puntos: 1 },
      { tipo: "desarrollo", enunciado: "Describí el recorrido de un óvulo desde que se produce hasta que puede dar inicio a un embarazo.", guia: "El óvulo se forma en el ovario → con la ovulación es liberado → viaja por la trompa de Falopio (aquí puede ser fertilizado por un espermatozoide) → el óvulo fertilizado (cigoto) llega al útero → se implanta en el endometrio → comienza el embarazo.", puntos: 3 },
    ],
  },
  {
    id: "inmuno-p",
    titulo: "El Sistema Inmunológico — Las Defensas del Cuerpo",
    nivel: "Primaria",
    modulo: "Sistema Inmunológico",
    emoji: "🛡️",
    color: "#ef4444",
    duracion: "35 min",
    preguntas: [
      { tipo: "multiple", enunciado: "¿Cuál es la función del sistema inmunológico?", opciones: ["Bombear sangre", "Defender al cuerpo contra enfermedades", "Digerir alimentos", "Filtrar la orina"], correcta: 1, puntos: 1 },
      { tipo: "multiple", enunciado: "¿Cómo se llaman las células 'soldado' que destruyen bacterias y virus?", opciones: ["Glóbulos rojos", "Plaquetas", "Glóbulos blancos (leucocitos)", "Neuronas"], correcta: 2, puntos: 1 },
      { tipo: "multiple", enunciado: "¿Qué produce el cuerpo para recordar cómo combatir un microbio después de una infección?", opciones: ["Hormonas", "Anticuerpos y células de memoria", "Glóbulos rojos", "Enzimas digestivas"], correcta: 1, puntos: 1 },
      { tipo: "vf", enunciado: "La fiebre es una respuesta del sistema inmune que ayuda a combatir infecciones.", correcta: true, puntos: 1 },
      { tipo: "vf", enunciado: "Una persona vacunada no puede contagiar enfermedades a otros.", correcta: false, puntos: 1 },
      { tipo: "vf", enunciado: "La piel es la primera barrera defensiva del sistema inmunológico.", correcta: true, puntos: 1 },
      { tipo: "completar", enunciado: "Las ___ son proteínas producidas por el sistema inmune que se unen a los patógenos para neutralizarlos.", respuesta: "anticuerpos", puntos: 1 },
      { tipo: "completar", enunciado: "Una ___ introduce al cuerpo una versión debilitada o inactiva del patógeno para que el sistema inmune aprenda a reconocerlo.", respuesta: "vacuna", puntos: 1 },
      { tipo: "multiple", enunciado: "¿Qué pasa cuando el sistema inmune reacciona exageradamente a una sustancia inofensiva como el polen?", opciones: ["Produce más glóbulos rojos", "Causa una alergia", "Genera más anticuerpos permanentes", "Activa la digestión"], correcta: 1, puntos: 1 },
      { tipo: "desarrollo", enunciado: "Explicá qué hace el cuerpo cuando entra una bacteria. Describirí al menos 3 pasos de la respuesta inmune.", guia: "1. La piel/mucosa intenta bloquear la entrada. 2. Si pasa, los glóbulos blancos detectan y atacan la bacteria. 3. Se liberan señales de alarma (inflamación). 4. Se producen anticuerpos específicos. 5. Se crean células de memoria para próximas infecciones.", puntos: 3 },
    ],
  },
];
