          ...
          structures: [
            {
              ...
              emoji: "⏳",
              color: "#78350f",
              simple: "El homínido más antiguo conocido. Vivió hace 7 millones de años en Chad y ya tenía indicios de caminar erguido.",
              full: "Sahelanthropus tchadensis ('Toumaï') es el homínido más antiguo conocido. Tenía cara relativamente plana y cresta nucal baja (indicios de bipedismo), pero caja craneal pequeña (~350 cc). Marca la divergencia entre el linaje humano y el de los chimpancés hace 6-7 Ma.",
            },
            {
              name: "Australopithecus — Lucy (3,2 Ma)",
              emoji: "🦶",
              color: "#a16207",
              simple: "Lucy es el Australopithecus afarensis más famoso. Caminaba erguida pero también trepaba árboles. Era pequeña (1,1 m) y vivió en África oriental.",
              full: "AL 288-1 'Lucy' fue hallada en Hadar, Etiopía, en 1974. Tenía 1,1 m de altura y ~29 kg. Las huellas fosilizadas de Laetoli (3,6 Ma) confirman que A. afarensis ya era bípedo completo. Cerebro ~450 cc. Es el candidato más sólido como ancestro del género Homo.",
            },
            {
              name: "Homo habilis (2,5 Ma)",
              emoji: "🪨",
              color: "#b45309",
              simple: "El primer ser del género Homo. Fabricó las primeras herramientas de piedra (industria olduvayense) y tenía un cerebro más grande que los Australopithecus.",
              full: "Homo habilis ('hombre hábil', 2,5-1,5 Ma) fue el primero del género Homo. Cerebro ~600 cc. Fabricó herramientas de piedra tallada (modo 1, industria olduvayense). Vivió en África oriental. Consumía carroña además de vegetales. Representa la transición entre Australopithecus y Homo.",
            },
            {
              name: "Homo erectus (1,8 Ma)",
              emoji: "🔥",
              color: "#d97706",
              simple: "Cuerpo casi como el nuestro. Fue el primero en salir de África y en controlar el fuego. Tenía herramientas mucho más sofisticadas.",
              full: "Homo erectus (1,9-0,1 Ma) fue el primer homínido con proporciones corporales modernas (~1,7 m). Dominó el fuego (~1 Ma). Fabricó bifaces achelenses. Abandonó África hace ~1,8 Ma llegando a Georgia, Java y China. Cerebro ~1.000 cc. Existió durante más de 1,5 millones de años.",
            },
            {
              name: "Neandertal (400-40 Ka)",
              emoji: "❄️",
              color: "#92400e",
              simple: "Una especie humana robusta adaptada al frío de Europa y Asia. Tenía cultura, enterraba a sus muertos y su ADN sigue en nosotros.",
              full: "Homo neanderthalensis (400.000-40.000 a.p.) habitó Europa y Asia Central. Cerebro ~1.600 cc (mayor que el nuestro). Cuerpo robusto para el frío glacial. Evidencias de arte y ritual. Hibridó con Homo sapiens: el 1-4% del ADN de personas no africanas actuales es de origen neandertal (Premio Nobel 2022, Svante Pääbo).",
            },
            {
              name: "Homo sapiens (300 Ka — hoy)",
              emoji: "🧠",
              color: "#f59e0b",
              simple: "Nuestra especie. Evolucionó en África, salió hace 70.000 años y pobló todo el planeta. Es la única especie del género Homo que sobrevive.",
              full: "Homo sapiens evolucionó en África hace ~300.000 años. Cerebro ~1.350 cc con córtex prefrontal expandido (lenguaje, planificación, empatía). Salida masiva de África hace ~70.000 años. Desarrolló lenguaje complejo, arte rupestre, escritura y tecnología. Hoy somos ~8.100 millones, la especie de primate más numerosa.",
            },
            {
              name: "Línea evolutiva completa",
              emoji: "📈",
              color: "#f59e0b",
              simple: "En 7 millones de años el cerebro creció de 350 cc a 1.350 cc. La imagen muestra esta progresión: de los primeros homínidos a nosotros.",
              full: "Cronología: Sahelanthropus (7 Ma, 350 cc) → Australopithecus (4-2 Ma, 450 cc) → H. habilis (2,5 Ma, 600 cc) → H. erectus (1,8 Ma, 1.000 cc) → Neandertal (0,4 Ma, 1.600 cc) → H. sapiens (0,3 Ma, 1.350 cc). La imagen de arriba sigue el esquema de la 'Marcha del Progreso', el diagrama de evolución humana más reconocido del mundo.",
            },
          ],
        },
