        ...
        },
        {
          ...
          structures: [
            ...
            },
            {
              ...
              full: "La línea evolutiva: Australopithecus afarensis (4-2 Ma) → Homo habilis (2,5 Ma) → Homo erectus (1,8 Ma) → Homo heidelbergensis (0,5 Ma) → Homo neanderthalensis / Homo sapiens (0,3 Ma). El cerebro creció de ~450 cc en Lucy a ~1.350 cc en nosotros. Los siguientes dos modelos (Homo erectus y Neandertal) muestran ese camino con reconstrucciones de cuerpo completo.",
            },
          ],
        },
        {
          ...
          structures: [
            {
              ...
              full: "Homo erectus ('hombre erguido', 1,9 Ma - 0,1 Ma) fue el primer homínido con proporciones corporales modernas: piernas largas para correr, cuerpo alto (~1,6-1,8 m). Esta reconstrucción del GVALS (Indiana State University) muestra el cuerpo completo. El 'niño de Turkana' (KNM-WT 15000, 1,6 Ma) es el esqueleto más completo: estimaba 1,6 m a los ~8 años.",
            },
            {
              ...
              full: "H. erectus abandonó África hace ~1,8 Ma: Dmanisi (Georgia, 1,8 Ma), Java (1,6 Ma), China (0,8 Ma). Es el primer registro de un homínido fuera de África. Las poblaciones asiáticas sobrevivieron hasta hace ~100.000 años en Java. Este éxodo implicó cruzar territorios, adaptarse a nuevos climas y competir con megafauna local.",
            },
            {
              ...
              full: "Las evidencias más antiguas de uso controlado del fuego: Wonderwerk Cave (Sudáfrica, ~1 Ma) y Gesher Benot Ya'aqov (Israel, ~800.000 a.p.). La cocción aumenta la biodisponibilidad de proteínas y almidones, reduciendo el tiempo de masticación y el tamaño del intestino, liberando energía para el cerebro mayor. El fuego también organizó el campamento nocturno y la vida social.",
            },
            {
              ...
              full: "La industria achelense (modo 2, ~1,7 Ma-0,2 Ma): bifaces ovalados tallados por ambas caras con simetría bilateral. Requieren planificación y habilidad manual. Los bifaces de Olorgesailie (Kenia) muestran producción masiva. H. erectus también usó lanzas de madera (Schöningen, Alemania, ~400.000 a.p.).",
            },
            {
              ...
              full: "El volumen craneal de H. erectus varió de ~600 cc (primeros) a ~1.250 cc (tardíos). Este aumento se correlaciona con: dieta más proteica (carne + cocción), mayor socialización y fabricación de herramientas más complejas. Antes de H. erectus vino Homo habilis (2,5 Ma, ~600 cc), el primero del género Homo, que fabricó las primeras herramientas de piedra documentadas.",
            },
          ],
        },
        {
          ...
          structures: [
            {
              ...
              full: "Homo neanderthalensis (400.000-40.000 a.p.) habitó Europa, Oriente Medio y Asia Central. Cuerpo robusto y bajo (~1,65 m, ~80 kg) adaptado al frío glacial: huesos gruesos, pecho en barril, nariz grande para calentar el aire. Cerebro grande (~1.600 cc, mayor que el Homo sapiens moderno). Coexistieron con Homo sapiens durante ~5.000 años en Europa.",
            },
            {
              ...
              full: "Evidencias de comportamiento simbólico: enterramientos con flores y ocre (Shanidar, Iraq), ornamentos de garras de águila (Krapina, Croacia, 130.000 a.p.), pinturas rupestres (Cueva de los Aviones, España, >115.000 a.p.). Fabricaban herramientas musterienses (modo 3) y la industria Châtelperroniana. Cazaban mamuts y rinocerontes lanudos en grupo.",
            },
            {
              ...
              full: "El análisis del genoma neandertal (Svante Pääbo, Premio Nobel 2022) reveló hibridación con Homo sapiens hace ~60.000 años en Oriente Medio. Los no africanos actuales tienen 1-4% de ADN neandertal. Algunos alelos neandertales se seleccionaron positivamente: genes inmunes (HLA), adaptación al frío. Otros se asocian a mayor riesgo de depresión y coagulación alterada.",
            },
            {
              name: "Extinción",
              emoji: "💀",
              ...
              full: "Los Neandertales se extinguieron hace ~40.000-28.000 años. Hipótesis: (1) Competencia con Homo sapiens por recursos durante el último máximo glacial; (2) Epidemias de patógenos traídos por Homo sapiens; (3) Reducción genética por consanguinidad en poblaciones pequeñas; (4) Absorción gradual por hibridación. No fueron 'primitivos': fabricaban arte y herramientas tan complejas como las de Homo sapiens.",
            },
            {
              name: "Homo sapiens",
              emoji: "🧠",
              ...
              full: "Homo sapiens evolucionó en África hace ~300.000 años. Cráneo redondeado, mentón prominente y esqueleto grácil. Salió de África en varias oleadas; la principal hace ~70.000 años pobló Eurasia, Oceanía y América. Desarrolló lenguaje complejo, arte rupestre, música y comercio a larga distancia. Hoy existen ~8.100 millones de Homo sapiens, la especie más numerosa de primate.",
            },
            {
              ...
              full: "Encefalización: Sahelanthropus ~350 cc → Australopithecus ~450 cc → H. habilis ~600 cc → H. erectus ~1.000 cc → Neandertal ~1.600 cc → H. sapiens ~1.350 cc. El córtex prefrontal humano permite planificación, lenguaje y empatía. El parto humano es difícil por el tamaño craneal del bebé (compromiso obstétrico evolutivo).",
            },
          ],
        },
