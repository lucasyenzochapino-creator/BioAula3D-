...
export default function SistemaReproductorViewer() {
  return (
    <SketchfabViewer
      ...
      accent="#f472b6"
      intro="El sistema reproductor permite la formación de gametos y el desarrollo de un nuevo ser. Explorá la anatomía en 3D."
      structures={[
        {
          name: "Ovarios",
          emoji: "🌸",
        ...
        },
        {
          ...
          full: "Estructura glandular temporal formada por células de la granulosa y teca luteinizadas. Produce progesterona (y algo de estrógenos) durante la fase lútea (~14 días). Si no hay embarazo, degenera en corpus albicans. Con embarazo, la hCG mantiene el cuerpo lúteo.",
        },
        {
          name: "Fecundación y Cigoto",
          emoji: "✨",
          color: "#a855f7",
          simple: "La fecundación es cuando el espermatozoide se une al óvulo y forman una sola célula.",
          full: "La fecundación ocurre en la ampolla tubárica. El espermatozoide atraviesa la zona pelúcida y se fusiona con la membrana del oocito II. Se completa la meiosis II y se forman 2 pronúcleos. Al fusionarse los pronúcleos se forma el cigoto (2n), primera célula del nuevo individuo.",
        },
        {
